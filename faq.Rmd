...
### Bei der Pizzaaufgabe habe ich bei Senf wieder x vergeben... ich wollte von mir aus y nehmen, weil x ja schon vorher vergeben war, aber da kam immer ne Fehlermeldung. Irgendwo hab ich da einen Denkfehler glaube ich. Warum geht da nur x?
...
### Bei der Gehaltsaufgabe war in einer das Zuweisen mit "<-" und in der nächsten das Zuweisen mit "=". Geht hier beides, bei mir wurde zumindest bei beiden das gleiche ausgegeben? Ist <- prinzipiell durch = austauschbar?
