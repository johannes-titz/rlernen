...
description: >
  Selektieren, Filtern, Gruppieren und Aggregieren von Daten
tutorial:
  version: 3.0
output:
  learnr::tutorial:
...
![](images/Dtr7sjCVYAAfbeJ.jpg){width=100%}
...
Wie ist die Durchschnittsgröße von Männern und Frauen im Datensatz? Für die zusammenfassende Statistik sollte der Datensatz nach Geschlecht (`gender`) gruppiert werden. Benutze hierfür die Funktion `describeBy` aus dem Paket `psych`.
