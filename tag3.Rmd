...
Der Aufruf der gesamten Funktion läuft über den Namen, den wir der Funktion gegeben haben (`modus`) und die Parameter, die die Funktion hat, in diesem Fall nur einer (`x`). Wir können den Parameter beim Aufruf bennen, was etwas sauberer ist:
...
Nun aber wieder zum Ernst des Lebens. Was hatten wir noch in Methodenlehre I? Na klar, Abbildungen!
