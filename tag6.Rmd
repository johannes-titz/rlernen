...
q_n(6.83, "Welche Bewertung bekommt ein Film, der 0 Jahre alt ist und 120 Minuten geht. (Ignoriere hierfür den Effekt des Budgets. Runde auf 2 Dezimalstellen)")
```
...
q_n(1.45, "Um wie viel besser werden Filme von Christopher Nolan (im Vergleich zu anderen Regisseuren) beurteilt unter Kontrolle der restlichen Variablen?")
```
...
```
```{r hp-mpc, echo=FALSE}
q_n(1, "Wie viele Autos haben mehr als 250 PS?")
```
