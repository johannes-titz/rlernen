...
knitr::opts_chunk$set(fig.width=7, fig.height=4.9, echo = TRUE, cache = TRUE)
...
Lerne wie Du Daten lokal einliest (zusätzlich zu den hier gezeigten Übungen schau Dir dazu z. B. auch https://www.datacamp.com/community/tutorials/r-data-import-tutorial an).

Lerne `dplyr` und `ggplot2`. Tutorials dafür gibt es wie Sand am Meer. 

Schaue Dir Videos auf Youtube zu `R` an. Z. B. https://youtube.com/@methodenmonster

Lies Dir Blogs zu `R` auf https://www.r-bloggers.com durch. Schau auch gerne bei meinem Blog vorbei: https://johannestitz.com
